...
function moreAboutHome(address, distanceFromTown, hasNeighbours){
    ...
    let neigb=typeof(hasNeighbours);
    return ad+dist+neigb;
}
...
function moreAboutKaren(parents, noOfSiblings, isNuclearFamily){
    //let type=typeof(parents)+typeof(noOfSiblings)+typeof(isNuclearFamily);
    //return Boolean;
...
function sweetTooth(totalNoOfSweets, sweetsConsumedByKaren, sweetsConsumedInNMeters, metersToTravel){
    let sweet=(totalNoOfSweets-sweetsConsumedByKaren-(metersToTravel*sweetsConsumedInNMeters))/2;
    if(isNaN(sweet)){
